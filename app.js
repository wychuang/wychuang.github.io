const translations = {
  zh: {
    ...
    "availability.detail": "2026.08.11 起 · 每周 5 天 · 可实习 6 个月以上 · 上海 / 北京 / 深圳 / 杭州",
    "work.title": "我做过的几个项目。",
    ...
    "experience.lead": "我的路径横跨医学工程、工业设计和 AI 产品。这里先列教育背景，再列几段真正影响我工作方法的实践。",
  ...
  en: {
    ...
    "profile.alt": "Dot-matrix portrait of Yichen Wang",
    "nav.about": "About",
    "nav.work": "Work",
    ...
    "availability.detail": "From Aug 11, 2026 · 5 days/week · 6+ months · Shanghai / Beijing / Shenzhen / Hangzhou",
    ...
    "experience.lead": "I studied biomedical engineering and industrial design before moving into AI products. These are the experiences that shaped how I work.",
